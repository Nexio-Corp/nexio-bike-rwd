...
export default function HowItWorks() {
	return (
		<>
			...
			<h2>
				Sem dor de cabeça e longas burocracias, seu seguro na palma da sua
				mão
			</h2>
			<InfoCard
				sourceImage="public\static\little-bike.svg"
			...
			/>
			<InfoCard
				sourceImage="public\static\form.svg"
			...
			/>
			<InfoCard
				sourceImage="public\static\clipboard.svg"
